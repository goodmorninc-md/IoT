...
import { TabBar, useEffect } from "@arco-design/mobile-react";
import { IconHome } from "@arco-design/mobile-react/esm/icon";
...
export default function MyTabBar({ activeIndex = 0 }) {
